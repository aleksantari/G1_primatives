...
#
# Debug mode (motion_mode=False) publishes rt/lowcmd and locks every non-arm
# joint at its current q -- exactly right for the suspended, back-plate-mounted
# robot. Motion mode publishes rt/arm_sdk. simulation_mode bypasses the
# velocity clip so the retimer is the sole speed authority in sim.
...
class G1_29_ArmController:
    ...
    def get_arm_velocity_limit(self):
        return self.arm_velocity_limit
