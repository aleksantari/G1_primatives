...
python scripts/examples/02_pick.py --target sim --visualize --speed 0.5 --collision-world
python scripts/examples/03_playground.py --target sim --speed 0.5 --collision-world  # interactive GUI
```
